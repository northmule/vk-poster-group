...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            <th scope="row">ПРО?</th>
            <td>
                <input type="checkbox" name="<?php echo $plugin::PREF_PLG_PRO; ?>[vkposter_prooptions][chekpro]" <?php checked($vkposter_prooptions['chekpro'], 'on', 1); ?>/>
    ...
    <fieldset>
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    <input type="checkbox" name="<?php echo $plugin::PREF_PLG_PRO; ?>[vkposter_prooptions][woo_chek]" <?php checked($vkposter_prooptions['woo_chek'], 'on', 1); ?>/>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="checkbox" name="<?php echo $plugin::PREF_PLG_PRO; ?>[vkposter_prooptions][woo_price]" <?php checked($vkposter_prooptions['woo_price'], 'on', 1); ?>/>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="checkbox" name="<?php echo $plugin::PREF_PLG_PRO; ?>[vkposter_prooptions][woo_met]" <?php checked($vkposter_prooptions['woo_met'], 'on', 1); ?>/>
    ...
    <fieldset>
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row">Метки</th>
                <td>
                    <input type="checkbox" name="<?php echo $plugin::PREF_PLG_PRO; ?>[vkposter_prooptions][wp_met]" <?php checked($vkposter_prooptions['wp_met'], 'on', 1); ?>/>
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    wp_editor($vkposter_prooptions['wp_insert_global_text'], 'wp_insert_global_text', array(
                        'wpautop' => false,
                        'media_buttons' => 0,
                        'textarea_name' =>  $plugin::PREF_PLG_PRO.'[vkposter_prooptions][wp_insert_global_text]', //нужно указывать!
                        'textarea_rows' => 5,
                        'tabindex' => null,
                        'editor_css' => '',
                        'editor_class' => '',
